...
function ParticipantHome({
  ...
  const certificateReady =
    progress?.result_status === "completed" || progress?.result_status === "available";
      ...
      <div className="space-y-6 lg:col-span-3">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <ActionCard
            ...
            description="Unduh setelah psikolog menyelesaikan review"
            href="/certificate"
            disabled={!certificateReady}
            cta={certificateReady ? "Lihat sertifikat" : "Menunggu review"}
          />
        </div>
