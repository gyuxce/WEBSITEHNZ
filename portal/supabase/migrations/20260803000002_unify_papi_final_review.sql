-- Use the psychologist interpretation from the PAPI review as the single source
-- for the final review page. Existing final-review drafts still take precedence.
...
begin
  ...
  select
    ...
    coalesce(fr.participant_summary, pk.final_summary),
    fr.qc_notes,
    coalesce(
      fr.status,
      case
